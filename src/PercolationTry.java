...
public class PercolationTry {
    ...
    private class WeightedQuickUnionUF {
        ...
        /**
         * Initializes an empty union-isSameRoot data structure with N isolated components 0 through N-1.
         *
    ...
    public static void main(String[] args)
    {
        ...
        PercolationTry perc = new PercolationTry(N);
        int t = perc.simulate();
